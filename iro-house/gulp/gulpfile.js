...
const browserSyncOption = {
  proxy: "test.wp",// ローカルにある「Site Domain」に合わせる
...
const watchFilesProd = () => {
  ...
  gulp.watch(srcPath.img, gulp.series(imageWebp, browserSyncReload));//Img圧縮
  gulp.watch(srcPath.php, gulp.series(browserSyncReload))//Sassコンパイル
}
...
exports.dev = gulp.series(
  gulp.parallel(php, jsDev, cssSass, imageWebp),//初回起動時のみ実行
...
exports.default = gulp.series(
  gulp.parallel(php, jsProd, cssSass, imageWebp),//初回起動時のみ実行
